...
Der Frage-/Goldsatz wurde vor dem Hauptlauf unverändert durch den Study Owner
freigegeben, jedoch nicht unabhängig klinisch begutachtet. Erwartete Evidenz-
IDs und Coverage-Strata sind deshalb ein owner-freigegebener technischer
Referenzstandard. Alle Retrievalmetriken werden mit dieser Einschränkung
berichtet; sie dürfen nicht als unabhängige klinische Genauigkeit interpretiert
werden.
...
klinische Auswertung; Einzelrevieweranalysen sind Sensitivitätsanalysen. Diese
spätere unabhängige Antwortbewertung bleibt trotz der geänderten Pre-Freeze-
Freigabe vollständig verpflichtend.
...
PD-001 dokumentiert den Wechsel vom unabhängigen Fragefreeze zur Owner-
Freigabe; PD-002 dokumentiert die Anhebung des kumulativen Kostenlimits von
400 auf 500 USD ohne Zurücksetzen bisheriger Kosten. Beide Änderungen erfolgten
vor dem ersten der 800 Hauptstudienaufrufe.
